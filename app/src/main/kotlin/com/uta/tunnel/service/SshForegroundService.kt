package com.uta.tunnel.service
...
import com.uta.tunnel.MainActivity
import com.uta.tunnel.R

/**
 * SSH セッションが生きている間だけ常駐通知を出すフォアグラウンドサービス。
 * バックグラウンドでも接続中だと分かり、プロセスも生存しやすくなる（keepalive 補助）。
 * 接続時に [start]、切断時に [stop] を呼ぶ（[com.uta.tunnel.session.SessionController] から）。
 */
